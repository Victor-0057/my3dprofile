    ...
    <nav className={`${styles.paddingX} w-full flex items-center py-5 bg-fixed top-0 z-20 bg-primary`}>
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        onClick={() => {
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>Victor Profile &nbsp;<span className='sm:block hidden'> | If you dont take risks, you cant create a future.</span></p>
        </Link>
